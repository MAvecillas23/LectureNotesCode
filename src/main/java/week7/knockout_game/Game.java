...
public class Game {
    ...
    // program for the knockout dice game
    ...
    // gets and sets knockout numbers for each player
    private void setKnockoutNumbers() {
        ...
        for (Player p : players) {
            ...
            do {
                knockoutNumber = intInput("Player " + p.getName() + ", enter your knockout number." + " It must be 6,7,8 or 9.");
    ...
    // play game, roll dice, get score, find out knocked out or not
    private void play() {
    ...
    // tells and displays users if they were knocked out or not
